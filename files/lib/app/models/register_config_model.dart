...
class RegisterConfigModel {
  ...
  RegisterConfigModel.fromJson(Map<String, dynamic> json) {
    ...
    selectRolesDuringRegistration = json['selectRolesDuringRegistration'] != null
        ? List<String>.from(json['selectRolesDuringRegistration'])
        : [];
    ...
    switch (type) {
      ...
      case 'checkbox':
        return RegisterCheckboxWidget(
          (data){
            userSelectedData = data;
            // ////printuserSelectedData.runtimeType);
          }, 
          getTitle(),
          options ?? []
        );
