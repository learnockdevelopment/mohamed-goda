  ...
  Widget build(BuildContext context) {
    return Directionality(
      textDirection: locator<AppLanguage>().currentLanguage == 'ar'
          ? TextDirection.rtl
          : TextDirection.ltr,
      child: Consumer2<AppLanguageProvider, UserProvider>(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            RegisterWidget.codeInput(
                                controller1, codeNode1, codeNode2, null, onPastedCode),
                            space(0, width: 10),
                            RegisterWidget.codeInput(
                                controller2, codeNode2, codeNode3, codeNode1, onPastedCode),
                            space(0, width: 10),
                            RegisterWidget.codeInput(
                                controller3, codeNode3, codeNode4, codeNode2, onPastedCode),
                            space(0, width: 10),
                            RegisterWidget.codeInput(
                                controller4, codeNode4, codeNode5, codeNode3, onPastedCode),
                            space(0, width: 10),
                            RegisterWidget.codeInput(
                                controller5, codeNode5, null, codeNode4, onPastedCode),
                          ],
                        ),
                        const Spacer(),
                        // Verify Button
