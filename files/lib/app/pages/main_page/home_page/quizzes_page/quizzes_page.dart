...
class _QuizzesPageState extends State<QuizzesPage>
  ...
  void initState() {
    ...
    tabController = TabController(
        length: locator<UserProvider>().profile?.roleName != 'user' ? 4 : 2,
        vsync: this);
          ...
          Expanded(
              child: TabBarView(
                ...
                isLoadingMyResults
                    ? loading()
                    : myResults.isEmpty
                        ? emptyState(AppAssets.bioEmptyStateSvg,
                            appText.noResults, appText.youHaveNoQuizResults)
                              ...
                              children: [
                                ...
                                ...List.generate(myResults.length, (index) {
                                  return QuizzesWidget.item(
                                      myResults[index].quiz!, () async {
                                    await nextRoute(QuizInfoPage.pageName,
                                        arguments: [
                                          myResults[index].quiz!,
                                          myResults[index].status,
                                          myResults[index].usergrade,
                                          'MyResults'
                                        ]);
                                    ...
                                    getData();
                                      ...
                                      userGrade:
                                          '${myResults[index].usergrade}/${myResults[index].quiz?.totalmark}');
                                }),
                              ],
                            ),
                          ),
                        ...
                        child: Column(
                          children: [
                            ...
                            ...List.generate(notParticipated.length, (index) {
                              return QuizzesWidget.item(notParticipated[index],
                                  () async {
                                await nextRoute(QuizInfoPage.pageName,
                                    arguments: [
                                      notParticipated[index],
                                      notParticipated[index].status,
                                      null,
                                      'NotParticipated'
                                    ]);
                ...
                if (locator<UserProvider>().profile?.roleName != 'user') ...{
                  isLoadingStudentResults
                      ...
                      : studentResults.isEmpty
                          ? emptyState(
                              AppAssets.bioEmptyStateSvg,
                              appText.noStudentResults,
                              appText.noStudentResultsDesc)
                          : SingleChildScrollView(
                              physics: const BouncingScrollPhysics(),
                              padding: padding(),
                              child: Column(
                                children: [
                                  space(12),
                                  ...List.generate(studentResults.length,
                                      (index) {
                                    return userCard(
                                        ...
                                        studentResults[index].webinar?.title ??
                                            '',
                                        timeStampToDate(
                                            (studentResults[index].createdat ??
                                                    0) *
                                                1000),
                                        '',
                                      ...
                                      await nextRoute(QuizInfoPage.pageName,
                                          arguments: [
                                            ...
                                            studentResults[index].status,
                                            studentResults[index].usergrade,
                                            'StudentResults'
                                          ]);
                                      ...
                                      getData();
                                        ...
                                        gradeStatus:
                                            studentResults[index].status,
                                        userGrade:
                                            '${studentResults[index].usergrade}/${studentResults[index].quiz?.totalmark}');
                                  }),
                                ],
                              ),
                            ),
                  isLoadingListQuiz
                      ...
                      : listQuiz.isEmpty
                          ? const SizedBox
                              .shrink() // emptyState(AppAssets.bioEmptyStateSvg, appText.noContentForShow, appText.noStudentResultsDesc)
                          : SingleChildScrollView(
                              physics: const BouncingScrollPhysics(),
                              padding: padding(),
                              child: Column(
                                children: [
                                  ...
                                  ...List.generate(listQuiz.length, (index) {
                                    return QuizzesWidget.listItem(
                                      listQuiz[index],
                                      () {
                                        nextRoute(QuizInfoPage.pageName,
                                            arguments: [
                                              Quiz.fromJson(
                                                  listQuiz[index].toJson())
                                                ..title =
                                                    listQuiz[index].getTitle()
                                                ..questioncount =
                                                    listQuiz[index]
                                                        .questionCount
                                                ..avrage =
                                                    listQuiz[index].avrage
                                                ..studentcount = listQuiz[index]
                                                    .studentCount,
