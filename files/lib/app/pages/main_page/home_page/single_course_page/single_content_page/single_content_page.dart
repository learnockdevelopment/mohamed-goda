...
class _SingleContentPageState extends State<SingleContentPage> {
  ...
  void dispose() {
    // Cancel any subscriptions or listeners, if any
    super.dispose();
  }
          ...
          body: isLoading
            ...
            children: [
              ...
              Positioned(
                bottom: 20,
                right: 20,
                child: FloatingDeviceInfoWidget(),
              ),
              ...
              if (showViewButton) ...{
                Expanded(
                  ...
                  child: button(
                      ...
                      onTap: () {
                        // ////printsingleContentData?.storage);
                        // ////printsingleContentData?.fileType);
                        // ////printsingleContentData?.downloadLink);
