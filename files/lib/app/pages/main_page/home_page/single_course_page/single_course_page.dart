...
class _SingleCoursePageState extends State<SingleCoursePage>
  ...
  getData() async {
    ...
    int id = courseData?.id ?? (ModalRoute.of(context)?.settings.arguments as List?)?.first ?? 0;
    isBundleCourse = courseData?.type == 'bundle' ?? (ModalRoute.of(context)!.settings.arguments as List)[1];
