...
class _OptionsFilterState extends State<OptionsFilter> {
  ...
  Widget build(BuildContext context) {
        return Container(
          width: getSize().width,
          constraints:
              BoxConstraints(minHeight: 0, maxHeight: getSize().height * .8),
          child: directionality(
            ...
            child: Column(
              ...
              children: [
                ...
                button(
                    onTap: () {
                      locator<FilterCourseProvider>().upcoming =
                          upcomingClasses;
                      locator<FilterCourseProvider>().free = freeClasses;
                      locator<FilterCourseProvider>().discount =
                          discountClasses;
                      locator<FilterCourseProvider>().downloadable =
                          downloadabeClasses;
                      locator<FilterCourseProvider>().bundleCourse =
                          bundleCourse;
