        ...
        child: directionality(
          ...
          child: Column(
            ...
            children: [
              ...
              switchButton(appText.availableForMeetings, availableForMeetings,
                  (value) {
                setState(() {
                ...
                Column(
                  children: [
                    SizedBox(
                        height: 12), // Adds space only if canPurchase is true
                ...
                Column(
                  children: [
                    SizedBox(height: 12),
                    switchButton(appText.discountedClasses, discountClasses,
                        (value) {
                      setState(() {
              ...
              switchButton(appText.downloadableContent, downloadabeClasses,
                  (value) {
                setState(() {
              ...
              SizedBox(
                  ...
                  child: AnimatedCrossFade(
                    ...
                    secondChild: Wrap(
                      ...
                      children: List.generate(allCategories.length, (index) {
                        return GestureDetector(
                          onTap: () {
                            checkCategory(index)
                                ? categoriesSelected.removeWhere((element) =>
                                    element.id == allCategories[index].id)
                                : categoriesSelected.add(allCategories[index]);
                    ...
                    crossFadeState: allCategories.isEmpty
