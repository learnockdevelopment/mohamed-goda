...
class FinalizeDatePage extends StatefulWidget {
  ...
  const FinalizeDatePage(this.date, this.selectedTime, this.profile,
      {super.key});
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Text(
                          ...
                          Text(
                            CurrencyUtils.calculator(widget
                                    .selectedTime.meeting?.priceWithDiscount ??
                                0),
                            style: style14Regular().copyWith(color: greyB2),
                          ),
                      ],
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text(
                          CurrencyUtils.calculator(widget.selectedTime.meeting
              ...
              UserProfileWidget.tabView(appText.inPerson, appText.online,
                  conductionType == MeetingTypes.inPerson, (value) {
                if (widget.selectedTime.meeting?.inPerson == 1) {
                  conductionType =
                      value ? MeetingTypes.inPerson : MeetingTypes.online;

                  participatesSliderValue = 0.0;
                  participates = conductionType == MeetingTypes.inPerson
                      ? (widget.selectedTime.meeting?.inPersonGroupMinStudent ??
                          0)
                      : (widget.selectedTime.meeting?.onlineGroupMinStudent ??
                          0);
                }
              ...
              UserProfileWidget.tabView(
                  appText.individual, appText.group, isIndividual, (value) {
                if (widget.selectedTime.meeting?.groupMeeting == 1) {
                  isIndividual = value;
                  setState(() {});
                }
                  ...
                  child: LayoutBuilder(builder: (context, size) {
                    return GestureDetector(
                      onHorizontalDragUpdate: (details) {
                        var max = conductionType == MeetingTypes.inPerson
                            ? (widget.selectedTime.meeting
                                    ?.inPersonGroupMaxStudent ??
                                0)
                            : (widget.selectedTime.meeting
                                    ?.onlineGroupMaxStudent ??
                                0);
                        var min = conductionType == MeetingTypes.inPerson
                            ? (widget.selectedTime.meeting
                        ...
                        child: Stack(
                          ...
                          children: [
                            ...
                            AnimatedPositionedDirectional(
                                start: (participatesSliderValue *
                                        (size.maxWidth)) -
                                    (participatesSliderValue > .7 ? 30 : 0),
                                top: 13,
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      AnimatedAlign(
                                        ...
                                        alignment: participatesSliderValue < .2
                        ...
                        children: [
                          ...
                          Text(
                            conductionType == MeetingTypes.inPerson
                                ? CurrencyUtils.calculator(widget.selectedTime
              ...
              descriptionInput(descController, descNode, '',
                  isBorder: true, maxLine: 4),
