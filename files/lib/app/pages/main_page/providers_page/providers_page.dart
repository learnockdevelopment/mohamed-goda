...
class _ProvidersPageState extends State<ProvidersPage>
  ...
  getInstructors() async {
    ...
    var data = await ProvidersService.getInstructors(
  ...
  getOrganizations() async {
    ...
    var data = await ProvidersService.getOrganizations(
        availableForMeetings: locator<ProvidersProvider>().availableForMeeting,
        freeMeetings: locator<ProvidersProvider>().free,
        discount: locator<ProvidersProvider>().discount,
        downloadable: locator<ProvidersProvider>().downloadable,
  ...
  getConsultants() async {
    ...
    var data = await ProvidersService.getConsultations(
        availableForMeetings: locator<ProvidersProvider>().availableForMeeting,
        freeMeetings: locator<ProvidersProvider>().free,
        discount: locator<ProvidersProvider>().discount,
        downloadable: locator<ProvidersProvider>().downloadable,
  ...
  @override
  void dispose() {
    tabController.dispose(); // Dispose tab controller
    super.dispose();
  }
                        ...
                        children: [
                          !isLoading && instructorsData.isEmpty
                              ...
                              : GridView.builder(
                                  ...
                                  itemCount:
                                      isLoading ? 6 : instructorsData.length,
                          ...
                          !isLoading && organizationsData.isEmpty
                              ...
                              : GridView.builder(
                                  ...
                                  padding: const EdgeInsets.only(
                                      right: 21, left: 21, bottom: 100),
                                  itemCount:
                                      isLoading ? 6 : organizationsData.length,
                                  itemBuilder: (context, index) {
                                    return isLoading
                                        ? userProfileCardShimmer()
                                        : userProfileCard(
                          ...
                          !isLoading && consultantsData.isEmpty
                              ...
                              : GridView.builder(
                                  ...
                                  padding: const EdgeInsets.only(
                                      right: 21, left: 21, bottom: 100),
                                  itemCount:
                                      isLoading ? 6 : consultantsData.length,
                                  itemBuilder: (context, index) {
                                    return isLoading
                                        ? userProfileCardShimmer()
                                        : userProfileCard(
