...
class _ClassesPageState extends State<ClassesPage>
  ...
  getData() async {
    if (!mounted) return; // ✅ Prevent calling setState if disposed
    ...
    if (locator<UserProvider>().profile?.roleName != 'user') {
      ...
      if (!mounted) return; // ✅ Check before modifying state
  ...
  @override
  void dispose() {
    tabController.dispose(); // ✅ Dispose TabController properly
    super.dispose();
  }
            ...
            body: isLoading
                ...
                : !hasLogin
                    ? Column(
                        ...
                        children: [
                          emptyState(AppAssets.loginEmptyStateSvg,
                              appText.login, appText.loginDesc,
