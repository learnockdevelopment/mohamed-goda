...
class _SpecialOfferWidgetState extends State<SpecialOfferWidget> {
  ...
  void initState() {
    ...
    time = DateTime.fromMillisecondsSinceEpoch(widget.toDate * 1000)
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Text(
                                  appText.hr,
                                  style:
                                      style10Regular().copyWith(color: greyCF),
                                )
                              ],
                            ),
                          ...
                          Row(
                            ...
                            children: [
                              Text(
                                widget.percent,
                                style:
                                    style20Bold().copyWith(color: Colors.white),
                              ),
                              Text(
                                '%',
                                style:
